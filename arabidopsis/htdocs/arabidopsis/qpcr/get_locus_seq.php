...
$query="SELECT sequence FROM cloned_promoter WHERE locus='$file'";
...
?>
    ...
    <h4>Cloned promoter sequence from  <?php echo $file; $f=str_replace(".", "_", $file); ?> &nbsp <a href="downloadfile.php?file=tmp/seqfile_<?echo $f;?>.fasta" style="text-decoration: none;">Download Sequence</a> </h4>

 <p style="font-family: courier new, serif">
><?php echo $file;?> (promoter region) </p>
...
$fname = getcwd()."/tmp/seqfile_$f.fasta";
